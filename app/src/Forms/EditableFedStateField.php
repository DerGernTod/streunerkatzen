 ...
 * @package userforms
 */
class EditableFedStateField extends EditableFormField {
    private static $singular_name = 'Bundesland Dropdown';
    private static $plural_name = 'Bundesland Dropdowns';
    private static $table_name = 'Streunerkatzen_EditableFedStateFields';
    ...
    public function getCMSFields() {
        ...
        $fields->addFieldToTab(
            ...
            DropdownField::create('Default', _t(__CLASS__ . '.DEFAULT', 'Default value'))
                         ->setSource($this->getFederalStates())
